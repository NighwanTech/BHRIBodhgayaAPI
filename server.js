...
const { User, Department, Doctor, Faculty, Slot, Appointment, AppSetting, Contact, Notification, Notice, Announcement, Event, NewsTicker, TimeTable, FeeStructure } = require('./models');
